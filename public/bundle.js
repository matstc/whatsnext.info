...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_bootstrap_dist_css_bootstrap_theme_css__ = __webpack_require__(13);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__styles_css__ = __webpack_require__(15);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_sammy__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_sammy___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_sammy__);
...
window.app = __WEBPACK_IMPORTED_MODULE_4__app__["a" /* default */];

__WEBPACK_IMPORTED_MODULE_0_jquery___default()(function() {
  __WEBPACK_IMPORTED_MODULE_4__app__["a" /* default */].init();
});

__WEBPACK_IMPORTED_MODULE_5_sammy__(function(){
  this.get("/", function(){
    this.redirect("#/about");
  });

  this.get("#/about", function(){
    __WEBPACK_IMPORTED_MODULE_4__app__["a" /* default */].viewModel.activate(location.hash);
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()(document.head.getElementsByTagName("title")).text("What's Next? — About");
    __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.getJSON('/contributors', __WEBPACK_IMPORTED_MODULE_4__app__["a" /* default */].viewModel.contributors);
  });

  this.get("#/:language", function(){
    __WEBPACK_IMPORTED_MODULE_4__app__["a" /* default */].viewModel.repositories([]);
    var skippedLanguages = ['programming', 'rails', 'meteor'];
    if (__WEBPACK_IMPORTED_MODULE_0_jquery___default.a.inArray(this.params['language'], skippedLanguages) == -1){
      __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.getJSON('/repositories/' + this.params['language'], __WEBPACK_IMPORTED_MODULE_4__app__["a" /* default */].viewModel.repositories);
    }

    __WEBPACK_IMPORTED_MODULE_4__app__["a" /* default */].viewModel.activate(location.hash);

    if(typeof window !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__app__["a" /* default */].viewModel.activeLanguage()){
      var language = __WEBPACK_IMPORTED_MODULE_4__app__["a" /* default */].viewModel.activeLanguage();

      __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.getJSON('/resources/' + language.name.toLowerCase(), language.resources);

      setTimeout(function(){
        var toScroll = __WEBPACK_IMPORTED_MODULE_0_jquery___default()("h1#section")[0].getBoundingClientRect().top + __WEBPACK_IMPORTED_MODULE_0_jquery___default()(document.body).scrollTop() - 20;
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()("html, body").animate({ scrollTop: toScroll + "px" });
      }, 200);

      __WEBPACK_IMPORTED_MODULE_0_jquery___default()(document.head.getElementsByTagName("title")).text("What's Next? — " + language.name);
    }
  });
}).run();
...
// module
exports.push([module.i, "ul li {list-style-type:square;}\n.repository-list, .repository-list li {list-style-type: none;}\n.repository-list {margin:0; padding:0;}\n.repository-list li .info {padding-left:60px;}\n.repository-list li.odd {background-color:#f2f2f2;}\n.repository-list li img {float:right; width:80px; margin-left:10px;}\n.repository-list li .name {margin-top:0;}\n.repository-list li .star-count {margin-top:10px;}\n.repository-list li {clear:both; margin-bottom:30px; padding:20px 20px 25px 15px; min-height:120px; border-radius:3px;}\n.repository-list .rank {float:left; font-size:24px; color:#666; font-family:Luckiest Guy;}\n\n.language-list li {font-size:16px;}\n.language-list li.active a .logo {box-shadow:1px 1px #333;}\n.language-list li.about {margin-top:30px; border-top:1px solid #ccc; padding-top:10px;}\n.language-list li a .logo {letter-spacing:2px; font-size:24px; color:white; background-color:#999; padding:7px 0 2px 2px; width:46px; margin-right:5px; font-family:Luckiest Guy; border-radius:4px; display:inline-block; text-align:center;}\n\n.lead {letter-spacing:-1px; color:#666; border-top:1px dotted #ccc; font-family:Courier New, Courier;}\n.header h1 {font-size:42px;}\narticle h1 {border-bottom: 1px solid #ddd; font-size:38px;}\narticle ul {margin-bottom:20px; padding-left:25px;}\narticle {padding-bottom:300px;}\nh1, h2 {font-family: Luckiest Guy, Ubuntu, Verdana;}\np, .p-ish {line-height:24px; font-size:16px;}\n.p-ish ul li {margin: 15px 0;}\n* {font-family:Ubuntu, Verdana;}\nh2 {margin-top:60px; font-size:22px; letter-spacing:1px;}\n.panel h2 {margin:0; padding:0;}\n.footer {margin-bottom:20px; color:#888; font-size:12px;}\n.panel-heading h2 {cursor:pointer;}\n.panel-heading h2:hover {text-decoration:underline;}\n.panel-heading i {font-size:60%; margin-bottom:3px; vertical-align:middle; margin-right:3px;}\n.panel-heading {padding: 10px 10px 2px;}\n.call-to-contribute {text-align:center; color:#888; font-size:12px; margin:30px 0 0 0;}\n\n@media (min-width: 768px) {\n  .language-list {margin-top: 30px;}\n  .lead {font-size:20px;}\n  .content {margin-top:32px;}\n  .header h1 {margin-top:80px;}\n}\n", ""]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__bindings_js__ = __webpack_require__(18);
...
var Language = function(name, shortName, color){
  ...
  this.color = color;
  this.active = __WEBPACK_IMPORTED_MODULE_0_knockout___default.a.observable(false);
  this.resources = __WEBPACK_IMPORTED_MODULE_0_knockout___default.a.observable(null);
  return this;
};
...
var viewModel = new function(){
  ...
  self.repositories = __WEBPACK_IMPORTED_MODULE_0_knockout___default.a.observableArray([]);
  self.contributors = __WEBPACK_IMPORTED_MODULE_0_knockout___default.a.observableArray([]);
  self.activeNavItem = __WEBPACK_IMPORTED_MODULE_0_knockout___default.a.observable(null);
  ...
  self.activeLanguage = __WEBPACK_IMPORTED_MODULE_0_knockout___default.a.computed(function(){
...
var init = function(){
  __WEBPACK_IMPORTED_MODULE_0_knockout___default.a.applyBindings(viewModel);
};
...
__WEBPACK_IMPORTED_MODULE_0_knockout___default.a.bindingHandlers.rank = {
  update: function(element, valueAccessor, allBindings, viewModel, bindingContext) {
    var prefix = valueAccessor() || "";
    var oneBasedIndex = prefix + (bindingContext.$index() + 1);
    __WEBPACK_IMPORTED_MODULE_1_jquery___default()(element).text(oneBasedIndex);
  }
};

__WEBPACK_IMPORTED_MODULE_0_knockout___default.a.bindingHandlers.striped = {
  update: function(element, valueAccessor, allBindings, viewModel, bindingContext) {
    var jElem = __WEBPACK_IMPORTED_MODULE_1_jquery___default()(element);
